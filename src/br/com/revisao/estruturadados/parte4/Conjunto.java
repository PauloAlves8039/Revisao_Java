...
public class Conjunto<T> {
	...
	/*
	 * private boolean contemOtimizado(T elemento) { for(int i = 0; i <
	 * this.elementos.tamanho(); i++) { T el = this.elementos.recuperar(i);
	 * if(el.hashCode() == elemento.hashCode()) { return true; } } return false; }
	 */
